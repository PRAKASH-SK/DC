  ...
  const fetchProfileData = useCallback(async () => {
    try {
      ...
      const res = await axios.get(
        `${API_URL}/api/student/profile/${Number(storedId)}`
      );
        ...
        <TouchableWithoutFeedback onPress={flipCard}>
            ...
            <View style={styles.profileSection}>
              ...
              <View style={styles.idContainer}>
                ...
                <View style={styles.detailsContent}>
                  <DetailRow label="Registration No" value={profile.reg_num} />
                  <DetailRow label="Email" value={profile.emailid} />
                  <DetailRow label="Department" value={profile.department} />
                  <DetailRow label="Year of Study" value={profile.year} />
                </View>
              </View>
            </Animated.View>
          ...
          <View style={styles.idCard}>
            ...
            <View style={styles.profileSection}>
              ...
              <View style={styles.idContainer}>
                <Text style={styles.sectionTitle}>Disciplinary Records</Text>
                {totalCount === 0 ? (
